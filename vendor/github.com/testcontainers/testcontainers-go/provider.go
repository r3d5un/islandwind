...
type ContainerProvider interface {
	...
	CreateContainer(
		context.Context,
		ContainerRequest,
	) (Container, error) // create a container without starting it
	ReuseOrCreateContainer(
		context.Context,
		ContainerRequest,
	) (Container, error) // reuses a container if it exists or creates a container without starting
	RunContainer(
		context.Context,
		ContainerRequest,
	) (Container, error) // create a container and start it
